...
namespace MarkoStudio.Twist.TwitterApi
{
    ...
    {
        Task<List<Tweet>> GetAllTweets(string userName);
    }
    ...
    public class TwitterClient : ITwitterClient
    {
        ...
        public async Task<List<Tweet>> GetAllTweets(string userName)
        {
            var url = $"https://api.twitter.com/1.1/statuses/user_timeline.json?screen_name={userName}&exclude_replies=true";
